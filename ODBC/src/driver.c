...
CSODBC_EXPORT SQLRETURN SQL_API SQLGetInfo(SQLHDBC connection,SQLUSMALLINT type,
    ...
    switch(type){
        ...
        case SQL_ODBC_VER:case SQL_DRIVER_ODBC_VER:return cs_info_string(d,out,capacity,length,CSODBC_ODBC_VERSION);case SQL_DBMS_NAME:return cs_info_string(d,out,capacity,length,"CubeSQL");
