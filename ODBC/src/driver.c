...
CSODBC_EXPORT SQLRETURN SQL_API SQLGetInfo(SQLHDBC connection,SQLUSMALLINT type,
    ...
    switch(type){
        ...
        case SQL_ODBC_VER:return cs_info_string(d,out,capacity,length,"03.80");case SQL_DBMS_NAME:return cs_info_string(d,out,capacity,length,"CubeSQL");
...
CSODBC_EXPORT SQLRETURN SQL_API SQLGetFunctions(SQLHDBC connection,SQLUSMALLINT id,SQLUSMALLINT *supported){
    cs_dbc *d=(cs_dbc *)connection;static const SQLUSMALLINT funcs[]={SQL_API_SQLALLOCHANDLE,SQL_API_SQLBINDCOL,SQL_API_SQLBINDPARAMETER,SQL_API_SQLCANCEL,SQL_API_SQLCLOSECURSOR,SQL_API_SQLCOLATTRIBUTE,SQL_API_SQLCOLUMNS,SQL_API_SQLCONNECT,SQL_API_SQLDESCRIBECOL,SQL_API_SQLDESCRIBEPARAM,SQL_API_SQLDISCONNECT,SQL_API_SQLDRIVERCONNECT,SQL_API_SQLENDTRAN,SQL_API_SQLEXECDIRECT,SQL_API_SQLEXECUTE,SQL_API_SQLFETCH,SQL_API_SQLFETCHSCROLL,SQL_API_SQLFOREIGNKEYS,SQL_API_SQLFREEHANDLE,SQL_API_SQLFREESTMT,SQL_API_SQLGETCONNECTATTR,SQL_API_SQLGETDATA,SQL_API_SQLGETDIAGFIELD,SQL_API_SQLGETDIAGREC,SQL_API_SQLGETENVATTR,SQL_API_SQLGETFUNCTIONS,SQL_API_SQLGETINFO,SQL_API_SQLGETSTMTATTR,SQL_API_SQLGETTYPEINFO,SQL_API_SQLMORERESULTS,SQL_API_SQLNATIVESQL,SQL_API_SQLNUMPARAMS,SQL_API_SQLNUMRESULTCOLS,SQL_API_SQLPARAMDATA,SQL_API_SQLPREPARE,SQL_API_SQLPRIMARYKEYS,SQL_API_SQLPUTDATA,SQL_API_SQLROWCOUNT,SQL_API_SQLSETCONNECTATTR,SQL_API_SQLSETENVATTR,SQL_API_SQLSETSTMTATTR,SQL_API_SQLSPECIALCOLUMNS,SQL_API_SQLSTATISTICS,SQL_API_SQLTABLES,SQL_API_SQLTRANSACT};size_t i;
